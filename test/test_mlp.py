...
def test_mlp_toy_dataset():
	...
	plt.savefig('/Users/thomas/DevSandbox/InfiniteSandbox/tag-lab/abgrund/test/dump/data.png')
	plt.close()
	####

	# eta=1.0; layer_size=200; lambda=0.1; activation=relu; weight_initialisation=xavier ###
	gd_params = {
			'step_rate': 1.0
	}

	mlp = MLP(shape=[(2, 200), 200, (200, 3), 3], dropout_proba=None, activation_fn='relu', max_epochs=10000,
	...
	fig.savefig('/Users/thomas/DevSandbox/InfiniteSandbox/tag-lab/abgrund/test/dump/mlp_decision_boundary.png')
	####
			...
			for l in [0.001, 0.01, 0.1, 1.]:
				for afn in ['relu', 'sigmoid', 'tanh']:
					for wi in ['xavier', 'randn']:
						...
						print('### CONFIG: eta={}; layer_size={}; lambda={}; activation={}; weight_initialisation={} ###'.format(sr, hh, l, afn, wi))
